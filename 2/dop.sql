...
CREATE DATABASE IF NOT EXISTS dop;
USE dop;
CREATE TABLE IF NOT EXISTS dop.users
(
...
CREATE TABLE IF NOT EXISTS dop.clients
(
    id    int auto_increment primary key,
    login varchar(255),
    pass  varchar(255),
...
CREATE TABLE IF NOT EXISTS dop.posts
(
    id        int auto_increment primary key,
    title     varchar(255),
    full_text text,
...
ALTER TABLE users 
ADD client_id INT DEFAULT NULL AFTER male;
ALTER TABLE users 
